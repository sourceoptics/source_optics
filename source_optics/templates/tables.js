function authorNav(value) {
   var index = "<a href='/author/" + value + "' aria-label='" + value + "'><i aria-hidden='true' class='fas fa-user' title='" + value + "'></i></a>&nbsp;";
...
function repoNav(value) {
   var index = "<a href='/repo/" + value + "' aria-label='" + value + "'><i aria-hidden='true' class='fas fa-database' title='" + value + "'></i></a>&nbsp;";
